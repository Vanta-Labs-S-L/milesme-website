...
const APP_STORE_URL = "https://apps.apple.com/app/id6760310174";
const GOOGLE_PLAY_URL =
  "https://play.google.com/store/apps/details?id=com.milesme.app";
          ...
          <div className={styles.phoneColumn}>
            ...
            <div className={styles.storeBadges}>
              <a
                ...
                aria-label="Download MilesMe on the App Store"
              >
                ...
                <div className={styles.storeBadgeText}>
                  <span className={styles.storeBadgeLabel}>Download on the</span>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Get MilesMe on Google Play"
              >
                <svg className={styles.storeIcon} width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                ...
                <div className={styles.storeBadgeText}>
                  <span className={styles.storeBadgeLabel}>Get it on</span>
